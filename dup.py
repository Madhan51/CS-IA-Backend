...
create_projects_table = "create table projectLists if not exists (id int AUTO_INCREMENT primary key, city char(40), name varchar(20) UNIQUE, image varchar(200) unique, brochure varchar(200) UNIQUE);"
...
create_employees_table = "create table employee if not exists (id int AUTO_INCREMENT primary key, name char(20), email char(30) not null unique, phone int(10) not null unique, designation char(20), password varchar(200) not null);"
...
"""
db.execute(create_employees_table)
...
db.execute(create_customer_table)
db.close()
